...
Skybox::Skybox()
{
  ...
  down->load(filepath + "_dn.tga", true);
  up->load(filepath +  "_up.tga", true);
  back->load(filepath + "_bk.tga", true);
  front->load(filepath + "_ft.tga", true);
  left->load(filepath + "_lf.tga", true);
  right->load(filepath + "_rt.tga", true);
