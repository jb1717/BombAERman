...
// Last update Sun Jun 14 23:41:03 2015 Milox Thomas
//
...
void		AGameObject::update(UNUSED gdl::Clock const& clock, UNUSED Binput &input, UNUSED Camera const& camera, UNUSED long int id)
{
